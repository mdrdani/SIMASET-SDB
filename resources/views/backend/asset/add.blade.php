        ...
        <div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form  action="{{ route('assetasset.store') }}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                    					@csrf
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select name="kategori" id="ketegori" class="select2_group form-control">
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="ukuran">Ukuran <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
