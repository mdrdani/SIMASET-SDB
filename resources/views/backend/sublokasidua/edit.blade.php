    ...
    <div class="right_col" role="main">
        ...
        <div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Sub Lokasi  {{ $lokasis->name }} - {{ $sublokasis->name }}<small>form input</small></h2>
								...
								<div class="x_content">
									<br />
									<form  action="{{ route('referensisublokasidua.update', ['id' => $lokasis->id, 'sublokasi' => $sublokasis->id, 'sublokasidua' => $data->id ]) }}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                    					@csrf
										@method('PUT')
										<input type="hidden" value="{{ $sublokasis->id }}" name="sub_lokasis_id">
                                        ...
                                        <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="name" name="luas" class="form-control " value="{{ $data->luas }}">
											</div>
										</div>
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
                                                <a href="{{ route('referensisublokasidua.index', ['id' => $lokasis->id, 'sublokasi' => $sublokasis->id]) }}" class="btn btn-info">Batal</a>
