    ...
    <div class="right_col" role="main">
        ...
        <div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Sub Lokasi Dua<small>form input</small></h2>
								...
								<div class="x_content">
									<br />
									<form  action="{{ route('referensisublokasidua.store') }}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                    					@csrf
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
                                                <a href="{{ route('referensisublokasidua.index') }}" class="btn btn-info">Batal</a>
